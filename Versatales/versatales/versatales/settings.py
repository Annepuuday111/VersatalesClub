"""
Django settings for versatales project.
...
SECRET_KEY = 'django-insecure-_ek+4jfnpb(!3n_iq0b9z85*(!#k90=qglwi(oi4j17e8vx6^8'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # Update this to your domain names in production
...
WSGI_APPLICATION = 'versatales.wsgi.application'
